...
feature -- Typography Classes
	...
	font_hero_headline: STRING = "text-4xl sm:text-5xl md:text-[6vw] lg:text-[8vw] font-light tracking-[-0.02em] leading-snug"
			-- Responsive hero headline: 4xl on mobile, scales up to 8vw on desktop (leading-snug = 1.375)

	font_section_headline: STRING = "text-2xl sm:text-3xl md:text-[4vw] lg:text-[5vw] font-medium leading-snug"
			-- Responsive section headline: 2xl on mobile, scales up to 5vw on desktop (leading-snug = 1.375)
