...
feature -- Typography Classes
	...
	font_section_headline: STRING = "text-2xl sm:text-3xl md:text-4xl font-medium leading-snug"
			-- Responsive section headline: capped at 4xl with snug line-height for constrained containers
